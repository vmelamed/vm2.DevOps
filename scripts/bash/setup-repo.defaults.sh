...
declare -rxA actions_default_vars=(
    ...
    ["NUGET_USERNAME"]="vmelamed"     # The default username to use for the selected NuGet server. github - vmelamed, nuget - your NuGet.org username, custom server - as required.
