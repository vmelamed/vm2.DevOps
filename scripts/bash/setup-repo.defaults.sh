...
declare -rxA actions_default_vars=(
    ...
    ["NUGET_USERNAME"]="valo@vtmelamed.com"     # The default username to use for the selected NuGet server. github - vmelamed, nuget - your NuGet.org username, custom server - as required.
