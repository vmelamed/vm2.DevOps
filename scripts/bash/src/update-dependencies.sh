...
#   - Enables 'globstar' so '**/packages.lock.json' recurses into nested project directories (e.g. 'src/<Package>/'),
#     not just direct children of the repo root.
...
function update_dependencies() {
    ...
    set +e
    shopt -s globstar # so **/packages.lock.json recurses into nested project directories (e.g. src/<Package>/)
    cd "$_repos/$_repo"
