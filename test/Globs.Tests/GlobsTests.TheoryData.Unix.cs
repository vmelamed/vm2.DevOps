...
public partial class GlobsTests
{
    ...
    [
        ...
        // ==========================================================================================================
        //                                         fileSys curDir  path  pattern                            enumerated         throws  results...
        ...
        new GlobEnumerate_TestData(TestFileLine("Find all directories recursively under /home/user"),
                                                   "FakeFSFiles/FakeFS.UnixGlob.json",
                                                           "/",    "/",  "/home/user/**/*",                 Enumerated.Directories,
                                                                                                                               false, "/home/user/docs/", "/home/user/projects/", "/home/user/media/", "/home/user/projects/alpha/", "/home/user/projects/beta/", "/home/user/projects/gamma/", "/home/user/media/images/", "/home/user/media/videos/"),
        ...
        new GlobEnumerate_TestData(TestFileLine("Match exact directory name"),
                                                   "FakeFSFiles/FakeFS.UnixGlob.json",
                                                           "/",    "/",  "/home/user/docs",                 Enumerated.Directories,
                                                                                                                               false, "/home/user/docs/"),
        ...
        new GlobEnumerate_TestData(TestFileLine("Find all project directories"),
                                                   "FakeFSFiles/FakeFS.UnixGlob.json",
                                                           "/",    "/",  "/home/user/projects/*",           Enumerated.Directories,
                                                                                                                               false, "/home/user/projects/alpha/", "/home/user/projects/beta/", "/home/user/projects/gamma/"),
        ...
        new GlobEnumerate_TestData(TestFileLine("Match empty folder as directory"),
                                                   "FakeFSFiles/FakeFS.UnixGlob.json",
                                                           "/",    "/",  "/home/user/media",                Enumerated.Directories,
                                                                                                                               false, "/home/user/media/"),
        ...
        new GlobEnumerate_TestData(TestFileLine("Complex bracket with multiple character classes [[:alpha:][:digit:]]"),
                                                   "FakeFSFiles/FakeFS.UnixGlob.json",
                                                           "/",    "/",  "/test/bracket-tests/[-[:alpha:].[:digit:]_]",
                                                                                                            Enumerated.Files,  false, "/test/bracket-tests/a", "/test/bracket-tests/b", "/test/bracket-tests/c", "/test/bracket-tests/x", "/test/bracket-tests/y", "/test/bracket-tests/z", "/test/bracket-tests/A", "/test/bracket-tests/B", "/test/bracket-tests/C", "/test/bracket-tests/1", "/test/bracket-tests/2", "/test/bracket-tests/3", "/test/bracket-tests/9"),
        ...
        new GlobEnumerate_TestData(TestFileLine("Many consecutive asterisks *** should work like *"),
                                                   "FakeFSFiles/FakeFS.UnixGlob.json",
                                                           "/",    "/",  "/etc/***",                        Enumerated.Files,  true,  "/etc/hosts", "/etc/passwd", "/etc/group", "/etc/fstab"),

        new GlobEnumerate_TestData(TestFileLine("Four asterisks **** should work like *"),
                                                   "FakeFSFiles/FakeFS.UnixGlob.json",
                                                           "/",    "/",  "/var/log/app****.log",            Enumerated.Files,  true,  "/var/log/app1.log", "/var/log/app2.log", "/var/log/app10.log"),
        ...
        new GlobEnumerate_TestData(TestFileLine("Many levels of single asterisk"),
                                                   "FakeFSFiles/FakeFS.UnixGlob.json",
                                                           "/",    "/",  "/*/*/*/*",                        Enumerated.Files,  false, "/home/projects/alpha/alpha.data", "/home/projects/alpha/alpha.log", "/home/projects/alpha/alpha.py", "/home/projects/beta/beta.data", "/home/projects/beta/beta.log", "/home/projects/beta/beta.py", "/home/user/docs/README.md", "/home/user/docs/archive.tar.gz", "/home/user/docs/backup.tar.bz2", "/home/user/docs/file1.txt", "/home/user/docs/file2.dat", "/home/user/docs/notes.txt", "/home/user/docs/readme.txt", "/home/user/projects/project-list.txt", "/opt/app/bin/app", "/opt/app/bin/tool1", "/opt/app/bin/tool2", "/opt/app/lib/libcore.so", "/opt/app/lib/libhelper.so.1", "/opt/app/lib/libutil.so"),
        ...
        new GlobEnumerate_TestData(TestFileLine("Simple FS: All directories recursively"),
                                                   "FakeFSFiles/FakeFS2.Unix.json",
                                                           "/",    "/",  "/**/*",                           Enumerated.Directories,
                                                                                                                               false, "/folder1/", "/folder3/", "/folder1/folder2/"),
        ...
        new GlobEnumerate_TestData(TestFileLine("Pattern with unmatched opening bracket [abc"),
                                                   "FakeFSFiles/FakeFS.UnixGlob.json",
                                                           "/",    "/",  "/test/bracket-tests/[abc",        Enumerated.Files,  false, []),
