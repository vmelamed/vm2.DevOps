...
{
    public static TheoryData<GlobEnumerateTheoryElement> Enumerate_EdgeCases =
    [
        // ==========================================================================================================
        // SYMLINKS AND JUNCTIONS (if supported by FakeFS)
        // ==========================================================================================================
        //                                         fsFile  glob                                  cwd    start       objects          _matchCasing                  throws  results...
        new GlobEnumerateTheoryElement(TestFileLine("Unix: Symlink files should be treated as files"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
                                                           "/**/link_to_file.txt",               "/",   "/",        Objects.Files,   MatchCasing.PlatformDefault, false,  "/links/link_to_file.txt"),

        new GlobEnumerateTheoryElement(TestFileLine("Unix: Symlink directories should follow into target"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
        ...
        // ==========================================================================================================
        new GlobEnumerateTheoryElement(TestFileLine("Win: Path near MAX_PATH limit (260 chars)"),
        ...
        new GlobEnumerateTheoryElement(TestFileLine("Win: Path exceeding MAX_PATH with long prefix"),
                                                   "FakeFSFiles/FakeFS8.Win.json",
        ...
        // ==========================================================================================================
        new GlobEnumerateTheoryElement(TestFileLine("Unix: Pattern with only spaces should enumerate from current"),
                                                   "FakeFSFiles/FakeFS2.Unix.json",
                                                           "   ",                                "/",   "/",        Objects.Files,   MatchCasing.PlatformDefault, false,  "/root.txt"),

        new GlobEnumerateTheoryElement(TestFileLine("Unix: Pattern with tabs and spaces"),
                                                   "FakeFSFiles/FakeFS2.Unix.json",
                                                           "  \t  ",                             "/",   "/",        Objects.Files,   MatchCasing.PlatformDefault, false,  "/root.txt"),
        ...
        // ==========================================================================================================
        new GlobEnumerateTheoryElement(TestFileLine("Unix: Files with numeric sequences - file[0-9].txt"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
        ...
        new GlobEnumerateTheoryElement(TestFileLine("Unix: Files with double-digit numbers - file[0-9][0-9].txt"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
        ...
        new GlobEnumerateTheoryElement(TestFileLine("Unix: Year patterns - log-202[0-5]-*.txt"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
        ...
        // ==========================================================================================================
        new GlobEnumerateTheoryElement(TestFileLine("Unix: Very deep nesting (10+ levels)"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
                                                           "/**/level10/*.txt",                  "/",   "/",        Objects.Files,   MatchCasing.PlatformDefault, false,  "/a/b/c/d/e/f/g/h/i/j/level10/deep.txt"),

        new GlobEnumerateTheoryElement(TestFileLine("Unix: Wide directory (100+ files)"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
                                                           "/wide/*.txt",                        "/",   "/",        Objects.Files,   MatchCasing.PlatformDefault, false), // ... 100+ files

        new GlobEnumerateTheoryElement(TestFileLine("Unix: Many siblings at same level"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
        ...
        // ==========================================================================================================
        new GlobEnumerateTheoryElement(TestFileLine("Unix: ISO 8601 date patterns - backup-????-??-??.tar.gz"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
        ...
        new GlobEnumerateTheoryElement(TestFileLine("Unix: Timestamp patterns - log-????-??-??T??-??-??.txt"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
        ...
        // ==========================================================================================================
        new GlobEnumerateTheoryElement(TestFileLine("Unix: Unicode with case - café vs CAFÉ vs Café"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
                                                           "/unicode/caf[éÉ].txt",               "/",   "/",        Objects.Files,   MatchCasing.PlatformDefault, false,  "/unicode/café.txt", "/unicode/cafÉ.txt"),

        new GlobEnumerateTheoryElement(TestFileLine("Unix: Cyrillic case sensitivity"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
                                                           "/unicode/файл.txt",                  "/",   "/",        Objects.Files,   MatchCasing.PlatformDefault, false,  "/unicode/файл.txt"),

        new GlobEnumerateTheoryElement(TestFileLine("Unix: Cyrillic uppercase ФАЙЛ.TXT"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
                                                           "/unicode/ФАЙЛ.TXT",                  "/",   "/",        Objects.Files,   MatchCasing.PlatformDefault, false,  "/unicode/ФАЙЛ.TXT"),
        ...
        // ==========================================================================================================
        new GlobEnumerateTheoryElement(TestFileLine("Unix: Literal hyphen at start [-abc].txt"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
                                                           "/special/[-abc].txt",                "/",   "/",        Objects.Files,   MatchCasing.PlatformDefault, false,  "/special/-.txt", "/special/a.txt"),

        new GlobEnumerateTheoryElement(TestFileLine("Unix: Literal hyphen at end [abc-].txt"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
                                                           "/special/[abc-].txt",                "/",   "/",        Objects.Files,   MatchCasing.PlatformDefault, false,  "/special/a.txt", "/special/-.txt"),

        new GlobEnumerateTheoryElement(TestFileLine("Unix: Escaped closing bracket [[]].txt"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
        ...
        // ==========================================================================================================
        new GlobEnumerateTheoryElement(TestFileLine("Unix: Many wildcards - */*/*/*/*/*/*/*.txt"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
        ...
        // ==========================================================================================================
        new GlobEnumerateTheoryElement(TestFileLine("Unix: Files starting with digits - [0-9]*.txt"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
                                                           "/numbers/[0-9]*.txt",                "/",   "/",        Objects.Files,   MatchCasing.PlatformDefault, false,  "/numbers/1file.txt", "/numbers/2data.txt", "/numbers/9test.txt"),

        new GlobEnumerateTheoryElement(TestFileLine("Unix: Files NOT starting with digits - [!0-9]*.txt"),
                                                   "FakeFSFiles/FakeFS8.Unix.json",
        ...
        // ==========================================================================================================
        new GlobEnumerateTheoryElement(TestFileLine("Unix: Verify depth-first order - results should be in DFS order"),
                                                   "FakeFSFiles/FakeFS7.Unix.json",
                                                           "/**/*.txt",                          "/",   "/",        Objects.Files,   MatchCasing.PlatformDefault, false),  // Order matters here

        new GlobEnumerateTheoryElement(TestFileLine("Unix: Verify breadth-first order - results should be in BFS order"),
                                                   "FakeFSFiles/FakeFS7.Unix.json",
                                                           "/**/*.txt",                          "/",   "/",        Objects.Files,   MatchCasing.PlatformDefault, false),  // Order matters here
    ];
}